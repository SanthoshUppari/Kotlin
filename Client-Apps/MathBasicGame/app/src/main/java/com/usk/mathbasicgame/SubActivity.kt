...
class SubActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textScore = findViewById(R.id.scoreTextView2)
        textLife = findViewById(R.id.lifeTextView2)
        textTime = findViewById(R.id.timeTextView2)

        textQuestion = findViewById(R.id.QTextView2)
        editTextAns = findViewById(R.id.ansEditText2)

        buttonOk = findViewById(R.id.okButton2)
        buttonNext = findViewById(R.id.nextButton2)
        ...
        buttonNext.setOnClickListener {
            ...
            if(lifeCount == 0){
                ...
                val intent = Intent(this@SubActivity, FinalActivity::class.java)
